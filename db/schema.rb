...
ActiveRecord::Schema.define(version: 20151229130401) do
  ...
  add_index "rates", ["charge_code_id"], name: "index_rates_on_charge_code_id", using: :btree
  ...
  add_foreign_key "rates", "charge_codes"
end
